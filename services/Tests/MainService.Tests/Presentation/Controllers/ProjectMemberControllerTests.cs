...
// {
//     private readonly Mock<IProjectMemberUseCase> _mockProjectMemberUseCase;
...
//     {
//         _mockProjectMemberUseCase = new Mock<IProjectMemberUseCase>();
...
//         mockServerCallContext.SetUserState("UserId", "test-user-id");
...
//         protected override WriteOptions WriteOptionsCore { get; set; } = new();
