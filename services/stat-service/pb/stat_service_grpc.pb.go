...
const (
	StatService_SearchTask_FullMethodName = "/pb.StatService/SearchTask"
)
...
type StatServiceClient interface {
	SearchTask(ctx context.Context, in *SearchTaskReq, opts ...grpc.CallOption) (*SearchTaskRes, error)
}
...
func (c *statServiceClient) SearchTask(ctx context.Context, in *SearchTaskReq, opts ...grpc.CallOption) (*SearchTaskRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchTaskRes)
	err := c.cc.Invoke(ctx, StatService_SearchTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatServiceServer interface {
	SearchTask(context.Context, *SearchTaskReq) (*SearchTaskRes, error)
...
func (UnimplementedStatServiceServer) SearchTask(context.Context, *SearchTaskReq) (*SearchTaskRes, error) {
...
func _StatService_SearchTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchTaskReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatServiceServer).SearchTask(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatService_SearchTask_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatServiceServer).SearchTask(ctx, req.(*SearchTaskReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _StatService_SearchTask_Handler,
		},
	},
